  ...
  methods: {
    ...
    evtManageUnidad(event) {
      if (event === "add") {
        ...
        this.notification_msg = "Unidad creada satisfactoriamente";
      } else {
        this.notification_color = "success";
        this.notification = true;
        this.notification_msg = "Unidad Actualizada satisfactoriamente";
      }
    },
    evtError(event) {
    ...
    removeItem() {
      ...
      this.actionDeleteUnidad(this.unidad__delete)
        .then(res => {
          this.notification_color = "success";
          this.notification = true;
          this.notification_msg = `Eliminada la unidad ${this.unidad__delete.siglas}`;
          this.overlay = false;
        })
        .catch(err => {
          this.overlay = false;
